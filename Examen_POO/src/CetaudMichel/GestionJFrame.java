...
public class GestionJFrame extends JFrame {
	...
	public GestionJFrame(){
		...
		btnLoad.addActionListener(e -> Personnel.LoadPersonnel());
		this.add(btnLoad);
		
		JButton btnAffichage = new JButton("Affichage liste du personnel");
		btnAffichage.setBounds(255,5,250,50);
		btnAffichage.addActionListener(e -> Personnel.Affichage());
		...
		btnPersonnel.addActionListener(e -> Personnel.GestionPersonnel());
