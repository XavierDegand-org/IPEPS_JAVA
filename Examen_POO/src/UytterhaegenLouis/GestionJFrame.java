...
public class GestionJFrame extends JFrame  {
	...
	private static Magasin mag =  new Magasin(); ; // création du magasin
	...
	public GestionJFrame()  {
		...
		this.setSize( 650 , 350 ); // Taille de l'écran de base
	...
	private class btnCloseApp implements ActionListener{
		...
		@Override
		public void actionPerformed (ActionEvent e) throws SecurityException  { // Action lors de l'appui sur le bouton fermer
			System.exit(0);
		}
